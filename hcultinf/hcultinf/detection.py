...
class DisequilibriumIntervalDetector:
    ...
    def __init__(self, time_arr, values_arr, emwa_tau_minutes=30, threshold=0.05):
    ...
    def get_intervals(self):
        return get_decreasing_regions(self._time_arr, self._values_arr, self._emwa_tau_minutes, self._threshold)
