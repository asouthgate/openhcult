...
was used. Inference was run with a burn-in of $400$, with $1000$ samples taken post-burnin.
...
As demonstrated in Appendix Figure \ref{fig:cornernoprior}, without anchor points, identifiability of $q_{dry}$ relies
...
For the simulated data case, a weaker prior was used, and as a result, banana-shaped joint posterior distributions are observed for $S$ and $q_{dry}$ for each sensor.
